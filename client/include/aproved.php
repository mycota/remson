...
<table class="table table-bordered table-hover" >
        ...
        <?php 
                ...
                logs($_SESSION['id'], $_SESSION['username'], "View aproved order list");
                 ...
                 while ($row = mysqli_fetch_assoc($select_cust)) {
                  ...
                  <tr>
                    ...
                    <td><a href='quotationmenu.php?source=review&wqrt=<?php echo $code; ?>'>Invoice</a> | <a  href='quotationmenu.php?source=raw&rw=<?php echo $code; ?>'>Order</a></td>
                  </tr>
                  <!-- onClick="javascript: return confirm('Are you sure to REMOVE!'); " -->
                    <?php
                }

        ...
        <?php 
                ...
                logs($_SESSION['id'], $_SESSION['username'], "View users");
                 ...
                 while ($row = mysqli_fetch_assoc($select_comment)) {
                    ...
                    echo "<td><a href='users.php?block=$user_id='>Block</a> |  <a href='users.php?unblock=$user_id'>Unblock</a>|<a href='users.php?source=resetpass&resetpass=$user_id'>ResetPassword</a> | <a href='users.php?source=lgs&resetpass=$user_id'>UserLog</a>";

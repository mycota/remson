...
<center><h1 class="page-header" style="background-color: #00CED1; color: white;">Pending Order
</h1></center>
...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = mysqli_real_escape_string($con,$_GET['page']);
    ...
    $query_count = "SELECT * from tbl_production WHERE deleted != 'Deleted' and cutting ='Done' and assemb = 'Done' and pack = 'Done' and disp = 'Done' and (total_tower - total_tower_ordered) > 0";
...
<table class="table table-bordered table-hover">
  ...
  $query = "SELECT * from tbl_production WHERE deleted != 'Deleted' and cutting ='Done' and assemb = 'Done' and pack = 'Done' and disp = 'Done' and (total_tower - total_tower_ordered) > 0 order by final_date_deli LIMIT $page1,15";
  
  $select_query = mysqli_query($con,$query);
  //confirmQuery($select_query);
  logs($_SESSION['id'], $_SESSION['username'], 'View completed orders');
  ...
  while ($row = mysqli_fetch_assoc($select_query)) {
    ...
    <td name="tcol20" id="tcol20"><a href='editEntry.php?id=<?php echo $proID_clean?>'>Edit</a> | <a onClick="javascript: return confirm('Are you sure to DELETE!'); " href='display.php?id=<?php echo $proID_clean?>'>Delete</a></td>
    </tr>
   ...
   <?php
      ...
      <?php
        // for deleting a enties
                ...
                logs($_SESSION['id'], $_SESSION['username'], "Deleted completed order $pro_id");

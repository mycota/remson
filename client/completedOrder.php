...
<center><h1 class="page-header" style="background-color: #00CED1; color: white;">Completed Order
</h1></center>
...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = mysqli_real_escape_string($con,$_GET['page']);
    ...
    $query_count = "SELECT * from tbl_production WHERE deleted != 'Deleted' and cutting ='Done' and assemb = 'Done' and pack = 'Done' and disp = 'Done'";
...
<table class="table table-bordered table-hover">
  ...
  $query = "SELECT * from tbl_production WHERE deleted != 'Deleted' and cutting ='Done' and assemb = 'Done' and pack = 'Done' and disp = 'Done' order by final_date_deli LIMIT $page1,15";
